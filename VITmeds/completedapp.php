...
$gender=$row["gender"];
$sql = "SELECT appoint_ID,date_schedule,time_allot, disease, registration_no FROM appointment a,profile p WHERE a.registration_no=p.reg_no and gender='$gender' and U_C='C'";
$result = mysqli_query($conn, $sql);
?>
...
<head>
    ...
    <title>VITmeds - Completed Appointments</title>
...
<body>
    ...
    <div class="container" style="margin-top:100px;">
        <h2>
            <center>Completed Appointments</center>
        </h2>
        <?php
            ...
            <table style="margin-bottom:40px;margin-top:20px;">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="prescription.php?reg=<?php echo $reg_no;?>&aid=<?php echo $a_id;?>" style="color: blue;text-decoration:none;background:#0EFF26;padding:4px;border-radius:15px;">View</a>
                        <a href="editprescription.php?mode=edit&reg=<?php echo $reg; ?>&aid=<?php echo $a_id;?>" style="color: blue;text-decoration:none;background:yellow;padding:4px;border-radius:15px;">Edit</a></td>
                    </tr>
                <?php        } ?>
            </table><?php
                } else {?>
