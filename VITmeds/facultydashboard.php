...
<body>
  ...
  <nav class="navbar">
    ...
    <a href="emergency.php?reg=<?php echo $reg;?>&mode=faculty" style="border-radius:8px;"><button class="styled-button" style="background-color:#27c0eb;border: none;color: white;padding: 15px 20px;text-align: center;
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content" style="margin-left:-130px;cursor:pointer;">
          <a href="studentprofile.php?reg=<?php echo $reg; ?>&mode=faculty">Profile</a>
      ...
      <ul class="menu_items">
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="consultdoctor.php?mode=faculty&reg=<?php echo $reg; ?>" style="text-decoration:none;">Consult Doctor</a>
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="history.php?reg=<?php echo $reg; ?>" style="text-decoration:none;">My Record History</a>
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="https://rzp.io/i/vitmeds" style="text-decoration:none;">Pharmacy</a>
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="procteedetails.php?reg=<?php echo $reg; ?>&mode=faculty" style="text-decoration:none;">Proctee Details</a>
          </div>
        </li>
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="feedback.php?mode=faculty&reg=<?php echo $reg; ?>" style="text-decoration:none;">Feedback</a>
...
?>
  ...
  <br><br><br><br><br><br>
  <h4 style="margin-left:300px;color:green;position:fixed;"><u>Emergency Contacts:</u></h4><br>
  <p style="margin-left:300px;position:fixed;"><b>Doctor - 7492756439 (Male), 9087435281 (Female)&emsp;&emsp;Hostel Warden - 6372956394 (Boys), 9428465647 (Girls)</b></p>
