...
$sql = "SELECT * FROM appointment WHERE registration_no='$reg'";
...
<head>
    ...
    <title>VITmeds - Record History</title>
                ...
                ?>
                    <tr>
                        ...
                        <?php } else { ?>
                            ...
                            <td><a href="prescription.php?reg=<?php echo $reg;?>&aid=<?php echo $a_id;?>" style="color: blue;text-decoration:none;"><u>Click Here</u></a></td>
                        <?php } ?>
                    </tr>
                <?php        } ?>
            </table><?php
