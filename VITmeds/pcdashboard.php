    ...
    <div class="navbar_content">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content" style="margin-left:-130px;cursor:pointer;">
          <a href="studentprofile.php?reg=<?php echo $reg; ?>&mode=pc">Profile</a>
      ...
      <ul class="menu_items">
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="consultdoctor.php?mode=pc&reg=<?php echo $reg; ?>" style="text-decoration:none;">Consult Doctor</a>
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="procteedetails.php?reg=<?php echo $reg; ?>&mode=pc" style="text-decoration:none;">All Student Details</a>
          </div>
        </li>
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="feedback.php?mode=pc&reg=<?php echo $reg; ?>" style="text-decoration:none;">Feedback</a>
