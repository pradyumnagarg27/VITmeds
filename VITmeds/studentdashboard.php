    ...
    <div class="navbar_content">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content" style="margin-left:-130px;cursor:pointer;">
          <a href="studentprofile.php?reg=<?php echo $reg; ?>&mode=student">Profile</a>
      ...
      <ul class="menu_items">
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="consultdoctor.php?mode=student&reg=<?php echo $reg; ?>" style="text-decoration:none;">Consult Doctor</a>
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="history.php?reg=<?php echo $reg; ?>" style="text-decoration:none;">Record History</a>
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="feedback.php?mode=student&reg=<?php echo $reg; ?>" style="text-decoration:none;">Feedback</a>
...
?>
  ...
  <p style="margin-left:300px;position:fixed;"><b>Proctor - <?php echo $proctor; ?>&emsp;&emsp;
      <?php if (!($r_status == "Day Scholar")) { ?>
        Warden - 9567290638 &emsp;&emsp;Supervisor - <?php
                                                      $b = "%BH" . substr($r_status, 18, 1);
                                                      $sql = "SELECT * FROM profile WHERE program like '$b'";
                                                      $result = mysqli_query($conn, $sql);
                                                      $row = mysqli_fetch_row($result);
                                                      $sup = $row[5];
                                                      echo $sup;
