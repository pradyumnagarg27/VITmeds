...
<body>
  ...
  <nav class="navbar">
    ...
    <a href="emergency.php?reg=<?php echo $reg;?>&mode=supervisor" style="border-radius:8px;"><button class="styled-button" style="background-color:#27c0eb;border: none;color: white;padding: 15px 20px;text-align: center;
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content" style="margin-left:-130px;cursor:pointer;">
          <a href="studentprofile.php?reg=<?php echo $reg; ?>&mode=supervisor">Profile</a>
      ...
      <ul class="menu_items">
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="consultdoctor.php?mode=supervisor&reg=<?php echo $reg;?>" style="text-decoration:none;">Consult Doctor</a>
        ...
        <li class="item">
          <div href="#" class="nav_link submenu_item">
            ...
            <a href="procteedetails.php?reg=<?php echo $reg; ?>&mode=supervisor" style="text-decoration:none;">Block <?php echo $block;?> Student Details</a>
          </div>
        </li>
        <li class="item">
          <div href="#" class="nav_link submenu_item">
...
?>
  ...
  <p style="margin-left:300px;position:fixed;"><b>Doctor - 7492756439 (Male)</b></p>
